...
urls = pd.read_csv("Element List/ESPN Cricinfo Element Scrapping URLs (LAN vs SUR).csv")
...
# create an empty dataframe for inserting scrapped values
...
for span in innings_soup.findAll('span', {
    #Check div class before operating- may need to change
...
file_name_prefix = f"Scrapped Data/{match_name}/{match_date}-{batting_team}-"
